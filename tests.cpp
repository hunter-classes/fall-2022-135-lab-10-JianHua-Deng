...
TEST_CASE("timeOverlap(TimeSlot ts1, TimeSlot ts2)"){
    ...
    //It saids I could be precise, such so when gap time = movie duration, overlap would be false, however, I didn't make such case because I thought it was optional, but it would be >= otherwise
